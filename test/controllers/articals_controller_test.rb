...
class ArticalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artical" do
    assert_difference('Artical.count') do
      post articals_url, params: { artical: { description: @artical.description, title: @artical.title } }
    end
  ...
  test "should update artical" do
    patch artical_url(@artical), params: { artical: { description: @artical.description, title: @artical.title } }
